...
import com.example.firechat.utils.UserAdapter;
...
public class UserListActivity extends AppCompatActivity {
            ...
            usersChildEventListener = new ChildEventListener() {
                ...
                public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                    ...
                    if(!user.getId().equals(auth.getCurrentUser().getUid())){
                        user.setAvatarMockUpResourse(R.drawable.person_50);
    ...
    private void buildRecyclerView() {
        ...
        userAdapter.setOnUserClcikListener(new UserAdapter.OnUserClcikListener() {
            @Override
            public void onUserClcik(int position) {
                goToChat(position);
            }
        });
